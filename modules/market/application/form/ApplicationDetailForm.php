...
class ApplicationDetailForm extends AppListForm
{
	public function fetchData()
	{
		...
		$util = Openbizx::getService(OPENBIZ_UTIL_SERVICE);
	...
	public function uninstall($repo_id,$app_id){
		$svc = Openbizx::getService("market.lib.PackageService");
   		$repoInfo = Openbizx::getObject("market.repository.do.RepositoryDO")->fetchById($repo_id);
   		...
   		if(preg_match("/com.application/si",strtolower($app_uid))){
	   		...
	   		//unload module
	   		include_once Openbizx::$app->getModulePath()."/system/lib/ModuleUnloader.php";
			...
			Openbizx::getObject("market.installed.do.InstalledDO")->deleteRecords($searchRule);		
   		}		
	}
