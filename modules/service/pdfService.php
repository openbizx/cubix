...
require_once(Openbizx::$app->getModulePath() . "/pdf/lib/mpdf50/mpdf.php");
define('_MPDF_PATH', Openbizx::$app->getModulePath() . "/pdf/lib/mpdf50/");
...
class pdfService
{
    ...
    public function setConfig($config = null)
    {
        ...
        if ($config['meta_author']) {
            switch ($config['meta_author']) {
                case "DEFAULT_USERNAME":
                    $this->pdfObj->setAuthor(Openbizx::$app->getUserProfile("username"));
                    break;
                case "DEFAULT_DISPLAY_NAME":
                    $this->pdfObj->setAuthor(Openbizx::$app->getUserProfile("profile_display_name"));
                    break;
                case "DEFAULT":
                    $this->pdfObj->setAuthor("Openbizx Cubi");
                    break;
                case "NONE":
        ...
        if ($config['meta_creator']) {
            switch ($config['meta_creator']) {
                case "DEFAULT":
                    $this->pdfObj->SetAuthor("Openbizx PDF Printer");
                    break;
                case "NONE":
    ...
    public function getDefaultConfig()
    {
        ...
        $systemConfigArr = Openbizx::getObject("pdf.do.PdfDO", 1)->directfetch();
