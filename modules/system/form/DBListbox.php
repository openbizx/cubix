...
class DBListbox extends InputElement
{
    ...
    public function getFromList(&$list)
    {
        ...
        $server = Openbizx::$app->getClientProxy()->getFormInputs('fld_server') ? Openbizx::$app->getClientProxy()->getFormInputs('fld_server') : $rec['server'];
        $port = Openbizx::$app->getClientProxy()->getFormInputs('fld_port') ? Openbizx::$app->getClientProxy()->getFormInputs('fld_port') : $rec['port'];
        $driver = Openbizx::$app->getClientProxy()->getFormInputs('fld_driver') ? Openbizx::$app->getClientProxy()->getFormInputs('fld_driver') : $rec['driver'];
        $username = Openbizx::$app->getClientProxy()->getFormInputs('fld_username') ? Openbizx::$app->getClientProxy()->getFormInputs('fld_username') : $rec['username'];
        $password = Openbizx::$app->getClientProxy()->getFormInputs('fld_password') ? Openbizx::$app->getClientProxy()->getFormInputs('fld_password') : $rec['password'];
        $charset = 'UTF8';
