...
class qq extends oauthClass
{
    ...
    function callback()
    {
        $keys = Openbizx::$app->getSessionContext()->getVar('qq_keys');
    ...
    function getUrl($call_back)
    {
        ...
        ;
        Openbizx::$app->getSessionContext()->setVar('qq_keys', $keys);
    ...
    {
        $tokens = Openbizx::$app->getSessionContext()->getVar('qq_access_token');
    ...
    function checkUser($oauth_token, $oauth_token_secret)
    {
        ...
        Openbizx::$app->getSessionContext()->setVar('qq_access_token', $access_token);
    }
