...
<div style="width:600px;height:600px;border:none;">
	...
	您可以通过 <a style="color:#02a5ea;" href="{$refer_url}/index.php/mystore/email_verify/code_{$code}">点击这里</a> 来完成身份认证，或登陆 <a href="{$refer_url}">Openbizx 客户服务中心</a>将您的身份验证码手工输入到对话框中即可完成电子邮件身份验证过程。<br/>
	<br/>顺祝商祺<br/>
	{$action_timestamp}
		</p>
