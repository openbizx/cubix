...
<div style="width:600px;height:600px;border:none;">
	...
	<div style="padding-left:60px;">
		<h1 style="font-size:24px; padding:0px; margin:0px;color:#333333;">欢迎您加入 Openbizx 中国</h1>
		<p style="font-size:14px; padding:0px; margin:0px;padding-top:30px;line-height:22px;color:#333333;padding-right:60px;">
		亲爱的 {$userinfo.username} ，<br/>欢迎您成为 Openbizx 中国区用户的成员，我们将致力于为您以及更多中国用户提供专业的服务。<br/>
	<br/>	
	为了给您提供更贴身的服务，我们还需要您提供更多必要的信息。请您可以通过登陆 <a style="color:#02a5ea;" href="{$refer_url}/index.php/mystore/account_setup">Openbizx 客户服务中心</a> 来初始化您的帐户，感谢您的信任与支持。<br/>
	<br/>顺祝商祺<br/>
	{$action_timestamp}
		</p>
