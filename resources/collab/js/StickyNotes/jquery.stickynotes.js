(function(jQuery) {
    ...
    jQuery.fn.stickyNotes.createNoteBackground = function(note) {
    	...
    	background.html('<img src="'+Openbizx.appUrl+'/js/StickyNotes/images/sticky-bg.jpg" class="opacity"  alt="" />')
//        if (jQuery.browser.msie && jQuery.browser.version <= 6)  {
//            background = $j(document.createElement('div')).addClass("background").html('<img src="images/spacer.gif" class="stretch" style="margin-top:5px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''+Openbizx.appUrl+'/js/StickyNotes/images/sticky-bg.png\',sizingMethod=\'scale\'");" alt="" />');
//        } else {
//            background = $j(document.createElement('div')).addClass("background").html('<img src="'+Openbizx.appUrl+'/js/StickyNotes/images/sticky-bg.png" class="stretch" style="margin-top:5px;" alt="" />');
//        }
