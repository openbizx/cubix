...
{literal}  
		    ...
		    <Element Name="fld_create_by" 
		    		...
		    		Link="{APP_INDEX}/collab/contact_detail/{Openbizx\Openbizx::$app->getProfile()->getProfileId(@:Elem[fld_create_by].Value)}" 
		    		AllowURLParam="N"/>
		    ...
		    <Element Name="fld_update_by" 
		    		...
		    		Link="{APP_INDEX}/collab/contact_detail/{Openbizx\Openbizx::$app->getProfile()->getProfileId(@:Elem[fld_update_by].Value)}" 
		    		AllowURLParam="N"/>
