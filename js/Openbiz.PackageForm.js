 ...
 */
Openbizx.PackageForm = Class.create(Openbizx.Form,
{
        ...
        fieldValues.each(function(tgt_ctnt) {
            ...
            if (tgt_ctnt.target == 'fld_status') {
                ...
                if (state == 'Install' ||
                    ...
                    setTimeout(function() {
                        Openbizx.CallFunction("package.local.form.PackageInstallerForm.getProgress()",null);
                    }, 2000);
                }
            }
...
Openbizx.ProgressBar = 
{
    set: function(divid, progress)
    {
        ...
        setTimeout(function() {
                alert('again');
                Openbizx.CallFunction("package.local.form.PackageLocalDetailForm.getProgress()",null);
            }, 1000);
    },
    get: function(divid)
    {
