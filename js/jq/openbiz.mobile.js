...
Openbizx.Net =
{
    ...
    {
		//if (Openbizx.activeForm) Openbizx.activeForm.displayLoading(true);
    ...
    processResponse: function(response)
    {
        ...
        for (i=0; i < respJson.length; i++) 
        {
            ...
            {
                case "ERROR":
                    Openbizx.Window.openPopupT(content,'Error',500,300); continue;
                case "POPUP":
...
Openbizx.Window =
{
    openPopup: function(url, w, h)
    {
        ...
        Openbizx.Window.openDialog(url, w, h);
    },
    openPopupT: function(text, title, w, h)
    {
        ...
        Openbizx.Window.openDialogT(text, w, h);
    },
