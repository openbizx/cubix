...
include_once (Openbizx::$app->getModulePath()."/tool/lib/DomMeta.php");
if(!defined("CLI")){
	exit;
}
...
// read do1 
$do1 = Openbizx::getObject($do1name);
$do1Table = $do1->mainTableName;
// read do2 
$do2 = Openbizx::getObject($do2name);
...
function getDoForms($doName) {
    ...
    $modulePath = Openbizx::$app->getModulePath()."/".$moduleName;
