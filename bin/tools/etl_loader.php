...
$lib_path = Openbizx::$app->getModulePath().DIRECTORY_SEPARATOR."report".DIRECTORY_SEPARATOR."etl".DIRECTORY_SEPARATOR."lib";
...
$lib_path = Openbizx::$app->getModulePath().DIRECTORY_SEPARATOR."report".DIRECTORY_SEPARATOR."etl".DIRECTORY_SEPARATOR."func";
foreach(glob($lib_path.DIRECTORY_SEPARATOR."*.php") as $filename){
	include_once($filename);
	if(defined("CLI")){
		echo "\t".basename($filename)." \n";
...
$conf_path = Openbizx::$app->getModulePath().DIRECTORY_SEPARATOR."report".DIRECTORY_SEPARATOR."etl".DIRECTORY_SEPARATOR."conf";
