<?php 
define('STR_WIZARD_TITLE',		'Openbizx Cubi 安装部署向导');
define('STR_BTN_START_NOW',		'现在开始!');
define('STR_BTN_INSTALL_CUBI',	'安装 Openbizx Cubi');
define('STR_BACK',				'上一步');
define('STR_NEXT',				'下一步');
define('STR_RETRY',				'重试');
...
define('STR_OPENBIZ_PATH',			'Openbizx 路径');
define('STR_OPENBIZ_PATH_FAIL',		'FAIL - OPENBIZ_PATH 没有正确指向到 Openbizx 的安装路径');
...
define('STR_INSTALLATION_COMPLETED_DESC',	'祝贺您已经完成了 Openbizx Cubi 安装向导。  <br />为了降低安全风险, <strong style="color:#666666;">我们强烈建议您现在动手删除 install 目录，<br/>并赋予 application.xml 只读的权限。</strong><br />并且在您正式使用系统前修改掉默认的系统密码。');
define('STR_DEFAULT_LOGIN_INFO',			'默认登陆信息');
define('STR_USERNAME',						'用户名');
define('STR_READY_GO',						'立即开始');
define('STR_LOGIN_TO_OPENBIZ',				'登陆 Openbizx Cubi');
