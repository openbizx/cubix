<?php 
define('STR_WIZARD_TITLE',		'Openbizx Cubi Installation');
define('STR_BTN_START_NOW',		'Start Now!');
define('STR_BTN_INSTALL_CUBI',	'Install Openbizx Cubi');
...
define('STR_OPENBIZ_PATH',			'Openbizx Path');
define('STR_OPENBIZ_PATH_FAIL',		'FAIL - OPENBIZ_PATH does not point to Openbizx installed path');
...
define('STR_INSTALLATION_COMPLETED_DESC',	'Congratulations for completing Openbizx Cubi Setup Wizard. <br />For security reason, <strong style="color:#666666;">we strongly recommend you to delete install folder and remove write permission on applicaiton.xml now.</strong><br />And also please change default login info before use.');
define('STR_DEFAULT_LOGIN_INFO',			'Default Login Info');
define('STR_USERNAME',						'Username');
define('STR_READY_GO',						'Ready Go');
define('STR_LOGIN_TO_OPENBIZ',				'Login to Openbizx Cubi');
