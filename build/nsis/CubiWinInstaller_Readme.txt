...
The installer supporting files are under cubi/build/nsis/
	...
	- Openbizx-Cubi_v2.1.0.0_Setup.nsi
	- package/README.txt
	- package/license.txt
	- package/php.ini
...
4. Edit 
Edit the Openbizx-Cubi_v2.1.0.0_Setup.nsi directly with text editor
...
5. Compile 
Start NSIS application, open Openbizx-Cubi_v2.1.0.0_Setup.nsi to generate the installer exe file.
Openbizx-Cubi_v2.1.0.0_Setup.exe will be generated under c:\dev\build\installer